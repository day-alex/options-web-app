...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in options_pb2_grpc.py depends on'
...
def add_OptionsServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'Options', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('Options', rpc_method_handlers)
